...
<v-form
  ...
  v-model="invalidChangePayForm"
  class="stripe-payment-form">
  <!-- start stripe styling -->
...
import { isName,
  ...
  isCity,
  statesOfTheUS,
  isZipCode } from '@/store/validationTypes';
...
export default {
  ...
  computed: {
    invalidChangePayForm: {
      get() {
        return this.validForm;
      },
      set(v) {
        this.validForm = v;
        const invalidForm = !this.validForm;
        const result = Boolean(invalidForm ||
  ...
  mounted() {
    ...
    if (window.Stripe === undefined) {
      ...
      this.cardCvc.mount('#card-cvc-form');
      this.cardExpiry.mount('#card-expiry-form');
      this.cardNumber.mount('#card-number-form');
